...
   - Đặt tên Project: **Online-auction**

   - Đặt Database Password: **XNJ3ZxHXZWtKFhyk**
...
   **postgresql://postgres:XNJ3ZxHXZWtKFhyk@db.qqbfnkjziobxltscbtxu.supabase.co:5432/postgres**



Hoặc lấy từng thông tin riêng lẻ:

   **- host: db.qqbfnkjziobxltscbtxu.supabase.co**
...
DB\_USER=postgres.your\_project\_ref

DB\_PASSWORD=your\_supabase\_password
...
SESSION\_SECRET=your\_super\_secret\_key\_here\_change\_this
...
MAIL\_PASS=your\_16\_char\_app\_password
...
FACEBOOK\_APP\_SECRET=your\_facebook\_app\_secret
...
        database: process.env.DB\_NAME || 'postgres'
...
Lưu ý: Thay các giá trị DB\_HOST, DB\_USER, DB\_PASSWORD bằng thông tin
...
7\. Copy password này vào MAIL\_PASS trong file .env
...
  - Đảm bảo DB\_HOST, DB\_USER, DB\_PASSWORD đúng với Supabase Dashboard
...
  - Kiểm tra MAIL\_USER và MAIL\_PASS trong .env
